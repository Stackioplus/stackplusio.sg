...
interface Initiative {
  ...
  title: string
  description: string
  type: 'code-editor' | 'lottie' | 'svg-frame'
...
const initiatives: Initiative[] = [
  {
    id: 1,
    title: 'CodeHer',
    description: 'We pledge to give away 10% of our profits to fund women in Bangladesh to learn coding.',
    type: 'code-editor',
    direction: 'left'
  },
  {
    id: 2,
    title: 'ProspHer Tech',
    description: 'We dedicate these people who are recipients for this scholarships to come back into the Stack+ Ecosystem to work as we build for the future.',
    type: 'lottie',
    direction: 'right'
  },
  {
    id: 3,
    title: 'Equalbytes',
    description: 'Mentorship, peer networks and advocacy that elevate women coders into visible tech-leadership roles, closing the gender gap in the digital workforce.',
    type: 'svg-frame',
    direction: 'left'
  }
]
...
"Every woman deserves equal access to education and careers in technology. " +
      "We are dedicated to empowering women and girls in Bangladesh through better " +
      "educational opportunities, because creating a fairer future through coding " +
      "begins with access and opportunity.";
</script>`
  ...
  useEffect(() => {
    ...
    const typewriterInterval = setInterval(() => {
      if (currentIndex <= codeText.length) {
        setDisplayedCode(codeText.substring(0, currentIndex))
        currentIndex++
      } else {
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#000000' }}>
      <style jsx>{`
        ...
        .initiative-from-right {
          opacity: 0;
          transform: translateX(150px);
          transition: all 0.8s cubic-bezier(0.25, 0.46, 0.45, 0.94);
        }

        .initiative-from-left.animate-in,
        .initiative-from-right.animate-in {
          opacity: 1;
        ...
        .initiative-image-container::before {
          content: '';
          position: absolute;
          inset: 0;
        ...
        .initiative-card:hover .initiative-image-container::before {
          opacity: 1;
        }
      ...
      <div ref={heroRef} className="min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 pt-16 sm:pt-0">
        <div className="max-w-5xl mx-auto text-center w-full">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-gray-100 mb-6 sm:mb-8 md:mb-12 lg:mb-16 px-2">
            Our Cause
          </h1>

          <div className="max-w-4xl mx-auto mb-8 sm:mb-12 md:mb-16">
            <pre className="text-left px-4 sm:px-6 py-3 sm:py-4 rounded-lg" style={{
              color: '#5eead4',
          ...
          {showScrollIndicator && isHeroInView && (
            <div className="flex flex-col items-center animate-bounce mt-4 sm:mt-0">
              <p className="text-gray-400 text-xs sm:text-sm mb-1 sm:mb-2">Scroll Down</p>
      ...
      <div className="min-h-screen flex items-center">
        ...
        <div
          ref={impactRef}
          className={`impact-section ${showImpact ? 'show' : ''} max-w-5xl mx-auto mt-8 sm:mt-16 md:mt-20 lg:mt-24 mb-12 sm:mb-20 md:mb-24 lg:mb-32 px-4 sm:px-6 lg:px-8`}
        >
          {/* Impact Heading */}
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-center mb-8 sm:mb-12 md:mb-16 lg:mb-20 px-2" style={{
            background: 'linear-gradient(-45deg, #f89b29, #ff0f7b)',
          ...
          {/* Big Numbers */}
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8 md:gap-10 lg:gap-12 mb-8 sm:mb-12 md:mb-16">
            <div className="text-center">
              <div className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-2">22</div>
              <div className="text-gray-400 text-base sm:text-lg md:text-xl">Women Helped</div>
            </div>
            <div className="text-center">
              <div className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-2">$715</div>
              <div className="text-gray-400 text-base sm:text-lg md:text-xl">Donations Raised</div>
            </div>
          </div>
          ...
          <div className="p-3 sm:p-6 md:p-8 lg:p-10">
            <div className="relative h-64 sm:h-80 md:h-96 lg:h-[28rem] xl:h-[32rem]">
              <svg className="w-full h-full" viewBox="0 0 650 400" preserveAspectRatio="xMidYMid meet">
                {/* Define gradient */}
                <defs>
                  <linearGradient id="graphGradient" x1="0%" y1="0%" x2="100%" y2="0%">
                    ...
                    <stop offset="100%" stopColor="#ff0f7b" />
                  </linearGradient>
                </defs>

                {/* Y-axis label */}
                <text x="15" y="200" fill="#ffffff" fontSize="16" fontWeight="bold" textAnchor="middle" transform="rotate(-90 15 200)">Women Helped</text>

                {/* Grid lines */}
                <line x1="80" y1="50" x2="80" y2="320" stroke="#333" strokeWidth="2"/>
                <line x1="80" y1="320" x2="600" y2="320" stroke="#333" strokeWidth="2"/>

                {/* Y-axis labels */}
                <text x="60" y="55" fill="#ffffff" fontSize="14" textAnchor="end">10</text>
                <text x="60" y="145" fill="#ffffff" fontSize="14" textAnchor="end">7</text>
                <text x="60" y="235" fill="#ffffff" fontSize="14" textAnchor="end">5</text>
                <text x="60" y="325" fill="#ffffff" fontSize="14" textAnchor="end">0</text>

                {/* Horizontal grid lines */}
                <line x1="80" y1="50" x2="600" y2="50" stroke="#333" strokeWidth="1" strokeDasharray="5,5"/>
                <line x1="80" y1="145" x2="600" y2="145" stroke="#333" strokeWidth="1" strokeDasharray="5,5"/>
                <line x1="80" y1="235" x2="600" y2="235" stroke="#333" strokeWidth="1" strokeDasharray="5,5"/>

                {/* Line path */}
                <path
                  d="M 200 235 L 340 145 L 480 50"
                ...
                {/* Data points */}
                <circle cx="200" cy="235" r="8" fill="url(#graphGradient)" stroke="#000000" strokeWidth="2"/>
                <circle cx="340" cy="145" r="8" fill="url(#graphGradient)" stroke="#000000" strokeWidth="2"/>
                <circle cx="480" cy="50" r="8" fill="url(#graphGradient)" stroke="#000000" strokeWidth="2"/>

                {/* Value labels on points */}
                <text x="200" y="220" fill="#ffffff" fontSize="16" fontWeight="bold" textAnchor="middle">5</text>
                <text x="340" y="130" fill="#ffffff" fontSize="16" fontWeight="bold" textAnchor="middle">7</text>
                <text x="480" y="35" fill="#ffffff" fontSize="16" fontWeight="bold" textAnchor="middle">10</text>

                {/* X-axis labels */}
                <text x="200" y="345" fill="#ffffff" fontSize="16" textAnchor="middle">October</text>
                <text x="200" y="365" fill="#ffffff" fontSize="13" textAnchor="middle">(Launched)</text>
                <text x="340" y="345" fill="#ffffff" fontSize="16" textAnchor="middle">November</text>
                <text x="480" y="345" fill="#ffffff" fontSize="16" textAnchor="middle">December</text>

                {/* X-axis label */}
                <text x="340" y="390" fill="#ffffff" fontSize="16" fontWeight="bold" textAnchor="middle">Month</text>
              </svg>
            </div>
          </div>
        </div>
      ...
      {/* Initiatives Section */}
      <div className="max-w-6xl mx-auto mt-12 sm:mt-16 md:mt-20 lg:mt-24 xl:mt-32 mb-12 sm:mb-16 md:mb-20 lg:mb-24 xl:mb-32 px-4 sm:px-6 lg:px-8">
        ...
        {/* Initiatives - Alternating Left/Right */}
        <div className="space-y-10 sm:space-y-12 md:space-y-16 lg:space-y-20 xl:space-y-24">
          {initiatives.map((initiative, index) => (
            <div
              ...
              className={`initiative-card ${initiative.direction === 'left' ? 'initiative-from-left' : 'initiative-from-right'}`}
            >
              <div
                className={`flex flex-col ${initiative.direction === 'left' ? 'lg:flex-row' : 'lg:flex-row-reverse'} gap-4 sm:gap-6 md:gap-8 lg:gap-10 items-center rounded-xl p-4 sm:p-6 md:p-8 lg:p-10`}
                style={{ backgroundColor: (initiative.type === 'code-editor' || initiative.type === 'svg-frame') ? '#1a1a1a' : 'transparent' }}
              >
                {/* Visual */}
                <div className="w-full lg:w-1/2 flex items-center justify-center scale-90 sm:scale-100">
                  {initiative.type === 'code-editor' && (
                    <div className="relative rounded-lg bg-slate-900 p-2 w-full max-w-md">
                  ...
                  <div className="w-full lg:w-1/2 space-y-3 sm:space-y-4 md:space-y-5">
                    <h3 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-teal-300">
                      {initiative.title}
                    </h3>
